...
tutors = ['Иван', 'Анастасия', 'Петр', 'Сергей', 'Дмитрий', 'Борис', 'Елена', 'Мария', 'Женя', 'Алиса' ]
klasss = ['9А', '7В', '9Б', '9В', '8Б', '10А', '10Б', '9А']

gen = (n for n in itertools.zip_longest(tutors, klasss, fillvalue=None))
print(list(gen))
